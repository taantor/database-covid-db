...
<body>
    <div class="container" id="signup">
        ...
        <form method="post" action="">
            <div class="input-group">
                ...
                <input type="text" name="fName" id="fName" placeholder="First Name" required value="<?php echo htmlspecialchars($firstName); ?>">
                <label for="fName">First Name</label>
            </div>
            <div class="input-group">
                <i class="fas fa-user"></i>
                <input type="text" name="lName" id="lName" placeholder="Last Name" required value="<?php echo htmlspecialchars($lastName); ?>">
    ...
    <div class="container" id="signIn" style="display:none;">
        ...
        <form method="post" action="">
            <div class="input-group">
                <i class="fas fa-envelope"></i>
                <input type="email" name="email" id="signInEmail" placeholder="Email" required value="<?php echo htmlspecialchars($email); ?>">
